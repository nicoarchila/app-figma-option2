  ...
  tokens: {
    components: {
      ...
      button: {
        ...
        _hover: {
          color: { value: "hsl(26, 100%, 52%)" },
          backgroundColor: { value: "hsl(220, 100%, 26%)" },
    ...
    colors: {
      ...
      orange: {
        10: { value: "hsl(26, 92%, 90%)" },
        20: { value: "hsl(26, 91%, 75%)" },
        40: { value: "hsl(26, 100%, 52%)" },
        60: { value: "hsl(26, 90%, 45%)" },
        80: { value: "hsl(26, 91%, 35%)" },
        90: { value: "hsl(30, 95%, 30%)" },
        100: { value: "hsl(30, 100%, 20%)" },
      },
      yellow: {
        10: { value: "hsl(58, 100%, 90%)" },
        20: { value: "hsl(58, 98%, 75%)" },
        40: { value: "hsl(57, 99%, 50%)" },
        60: { value: "hsl(57, 99%, 45%)" },
        80: { value: "hsl(57, 99%, 35%)" },
      ...
      brand: {
        primary: {
          10: { value: "hsl(107, 39%, 77%)" },
          20: { value: "hsl(107, 39%, 72%)" },
          40: { value: "hsl(107, 40%, 62%)" },
          60: { value: "hsl(107, 39%, 53%)" },
          80: { value: "hsl(107, 35%, 42%)" },
          90: { value: "hsl(107, 35%, 32%)" },
          100: { value: "hsl(106, 35%, 26%)" },
        },
        secondary: {
          10: { value: "hsl(223, 24%, 64%)" },
          20: { value: "hsl(221, 24%, 56%)" },
          40: { value: "hsl(222, 34%, 42%)" },
          60: { value: "hsl(222, 65%, 27%)" },
          80: { value: "hsl(222, 65%, 22%)" },
          90: { value: "hsl(221, 66%, 16%)" },
          100: { value: "hsl(221, 65%, 14%)" },
        },
      },
      font: {
        primary: { value: "hsl(0, 0%, 0%)" },
        secondary: { value: "hsl(226, 85%, 4%)" },
        tertiary: { value: "hsl(224, 19%, 35%)" },
        disabled: { value: "hsl(240, 2%, 62%)" },
        inverse: { value: "hsl(0, 0%, 100%)" },
        interactive: { value: "hsl(26, 100%, 52%)" },
        hover: { value: "hsl(26, 90%, 45%)" },
        focus: { value: "hsl(26, 90%, 45%)" },
        active: { value: "hsl(26, 90%, 45%)" },
        info: { value: "{colors.blue.90.value}" },
        warning: { value: "hsl(26, 90%, 45%)" },
        error: { value: "hsl(0, 95%, 30%)" },
        success: { value: "hsl(130, 43%, 46%)" },
      },
      background: {
        primary: { value: "hsl(0, 0%, 100%)" },
        secondary: { value: "hsl(0, 0%, 100%)" },
        tertiary: { value: "hsl(0, 0%, 100%)" },
      ...
      border: {
        ...
        focus: { value: "hsl(220, 100%, 26%)" },
        error: { value: "hsl(0, 95%, 30%)" },
      },
      shadow: {
        primary: { value: "hsl(107, 39%, 53%)" },

        ...
        >
          ...
          >
            <Flex
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "link387011157")}
            >
              <Flex
                gap="0"
                direction="row"
                ...
                {...getOverrideProps(overrides, "icon387011158")}
              >
                <MyIcon
                  display="block"
                  gap="unset"
                  ...
                  padding="0px 0px 0px 0px"
                  type="billetera"
                  {...getOverrideProps(overrides, "MyIcon387011159")}
                ></MyIcon>
              </Flex>
              <Text
                fontFamily="Inter"
                ...
                {...getOverrideProps(overrides, "label387011160")}
              ></Text>
            </Flex>
            <Flex
              gap="8px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "link387011161")}
            >
              <Flex
                gap="0"
                direction="row"
                ...
                padding="6px 6px 6px 6px"
                backgroundColor="rgba(0,0,0,0)"
                {...getOverrideProps(overrides, "icon387011162")}
              >
                <MyIcon
                  display="block"
                  gap="unset"
                  ...
                  padding="0px 0px 0px 0px"
                  type="peso"
                  {...getOverrideProps(overrides, "MyIcon387011163")}
                ></MyIcon>
              </Flex>
              <Text
                fontFamily="Inter"
                ...
                whiteSpace="pre-wrap"
                children="Pagos"
                {...getOverrideProps(overrides, "label387011164")}
              ></Text>
            </Flex>
            <Flex
              gap="8px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "link387011165")}
            >
              <Flex
                gap="0"
                direction="row"
                ...
                padding="6px 6px 6px 6px"
                backgroundColor="rgba(0,0,0,0)"
                {...getOverrideProps(overrides, "icon387011166")}
              >
                <MyIcon
                  display="block"
                  gap="unset"
                  ...
                  {...getOverrideProps(overrides, "MyIcon387011167")}
                ></MyIcon>
              </Flex>
              <Text
                fontFamily="Inter"
                ...
                whiteSpace="pre-wrap"
                children="Avances"
                {...getOverrideProps(overrides, "label387011168")}
              ></Text>
            </Flex>
            <Flex
              gap="8px"
